        ...
        children: [
          Center(
            child:FutureBuilder(
              ...
              : Image.asset('imagens/simp-gif.gif', width: 150, height: 150,)),
          ),
          isLoading ? Container(color: Colors.white, child: Center(child: Image.asset('imagens/simp-gif.gif', width: 150, height: 150,)))
          : Stack(),
        ],
      ),
    ),

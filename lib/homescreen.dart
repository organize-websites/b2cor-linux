...
import 'package:b2corapp/homeb2cor.dart';
...
import 'package:b2corapp/privacidade.dart';
import 'package:b2corapp/api/home_block.dart';
...
Future<void> main() async {
  ...
  print(token);
  runApp(MaterialApp(home: token == null ? HomePage() : B2cor2()));
}
...
containerButton(BuildContext context) {
  return Container(
    ...
    RoundedLoadingButton(
      ...
      onPressed: () {OneSignal.shared.setSubscription(true); _onClickLogin(context); _doSomething(); },
      width: 200,
    ),
  );
}
  ...
  navegaHomeSimp(BuildContext context){
    Navigator.push(context, MaterialPageRoute(builder: (context)=>Homeb2cor()),);
  }
